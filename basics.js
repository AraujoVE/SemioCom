...
//Used to type
module.exports.typeSlowly = async function (driver,vars){
    let string = vars[0];
    let xpathStr = vars[1]; 
    let waitTimeKey = 0.025;
    let waitTimeEnd = 0.5;
    for(const key of string){
        await driver.findElement(By.xpath(xpathStr)).sendKeys(key);
        await module.exports.wait(waitTimeKey);
    }    
    await module.exports.wait(waitTimeEnd);
}     
...
module.exports.getElemAttrByXPath = async function (driver,vars,waitTime=0){
    ...
    var element = await module.exports.getElement(driver,[xPathStr]);
...
module.exports.xPathWhileTrue = async function (driver,funct,vars,waitTime=0,waitBetween=0.5,maxRepts=1000){
    ...
    while(continueWhile === true){
        ...
        try{
            ...
            await module.exports.wait(waitBetween);
        }
        iter++;    
    }    
    await module.exports.wait(waitTime);
